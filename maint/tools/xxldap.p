...
OUTPUT STREAM stOut TO /home/qadeepro/ldap.xls UNBUFFERED.
...
FOR EACH usr_mstr
  ...
  PUT STREAM stOut UNFORMATTED
      ...
      usr_mstr.usr_type          CHR(9)
      usr_mstr.usr_logon_date    CHR(9)
      usr_mstr.usr_last_date     CHR(9)
