...
arch for NE condition */
 ...
 process for allTables */
  ...
  ELSE lSrcTable = "allTables".
   ...
   /*IF lcAsgnThread NE (STRING(liHugeThread) + ',11,12,13,14')*/

   IF lcAsgnThread NE (STRING(liHugeThread) + ',3,5,6,7,9,10,11,12,13,14,15')
